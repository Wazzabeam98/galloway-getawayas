...
export default async function ProviderListingPage() {
    ...
    const [{ data: areas }, { data: items }, { data: avail }] = await Promise.all([
        ...
        admin.from('service_provider_items').select('id, name, description, price, unit, image, duration_minutes, fulfilment, active, capacity, min_people, sort_order, included_guests, extra_adult_fee, extra_child_fee, max_party, is_custom')
