                        ...
                        {properties.map((property) => (
                            ...
                            >
                                ...
                                <div className="flex justify-between items-start">
                                    <h3 className="font-bold text-slate-900 text-base truncate">{property.city}, {property.country}</h3>
                                </div>
                                <p className="text-sm text-slate-500 truncate">{property.title}</p>
                                <p className="text-sm font-semibold text-slate-900">
                                    £{property.price} <span className="font-normal text-slate-500">night</span>
                                </p>
                            </div>
                        ))}
                    </div>
