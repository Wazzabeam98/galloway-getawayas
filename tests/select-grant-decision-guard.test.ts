...
const TABLES: TableDecision[] = [
    {
        ...
        revoked: {
            ...
            collection_address: 'the provider’s collection/pickup address; private, released only server-side on a confirmed (paid) order — never anon/authenticated; the owner reads their own back via the provider_private view',
